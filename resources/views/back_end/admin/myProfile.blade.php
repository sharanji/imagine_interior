                    ...
                    <div class="relative">
                        <div class="cover-container">
                            <?php
										...
										{
											?>
                            <img src="<?php echo asset('uploads/admin_cover_image/'.auth()->user()->id.'.png');?>" class="img-fluid bg-cover rounded-0 w-100" alt="Cover Image" style="max-height:350px">
                            <?php
										}
										else
										{
											?>
                            <img src="<?php echo "uploads/default-cover.jpg"; ?>" alt="Cover Image" style="max-height:350px;width:1030px;">
                            <?php
										}
									?>
                        </div>
                        <div class="profile-img-container d-flex align-items-center justify-content-between">
                            ...
                            <?php
										...
										{
											?>
                            <img src="<?php echo "uploads/no_image.png"; ?>" class="rounded-circle img-border box-shadow-1" alt="Profile Image">
                            <?php
										}
									?>
