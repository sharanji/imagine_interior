									...
									<div class="row">
										...
										<div class="col-md-4">
											<div class="form-group">
												...
												<div class="controls">
													<input type="text" name="gst_number" class="form-control" required value="{{GST_NUMBER}}" />
												</div>
											</div>
										</div>
										<div class="col-md-4">
											<div class="form-group">
												...
												<div class="controls">
													<input type="text" name="pan_number" class="form-control" required value="{{PAN_NUMBER}}" />
												</div>
											</div>
										</div>
										...
										<div class="col-lg-4 col-sm-12">
											<div class="form-group">
												...
												<div class="controls">
													<input type="text" class="form-control" name="contact_email" required value="{{CONTACT_EMAIL}}" >
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="controls">
													<input type="text" class="form-control" name="webmaster_email" required value="{{WEBMASTER_EMAIL}}" >
												</div>
											</div>
										</div>
										<div class="col-lg-4 col-sm-12">
											<div class="form-group">
												...
												<div class="controls">
													<input type="text" class="form-control" name="noreply_email" required value="{{NOREPLY_EMAIL}}" >
												</div>
											</div>
										</div>
									</div>
									<div class="row">
										...
										<div class="col-lg-6 col-sm-12">
											<div class="form-group">
												...
												<div class="controls">
													<textarea class="form-control" name="address2" required >{{ADDRESS2}}</textarea>
												</div>
											</div>
										</div>
										<div class="col-lg-6 col-sm-12">
											<div class="form-group">
												...
												<div class="controls">
													<textarea type="text" class="form-control" name="company_account" required >{{COMPANY_ACCOUNT}}</textarea>
												</div>
											</div>
										</div>
									</div>
								...
								<form action="" method="post">
									...
									<div class="row">
										<div class="col-lg-5">
											...
											<div class="controls">
												<input type="text" name="sms_sender_id" class="form-control" required  value="{{SMS_SENDER_ID}}">
											</div>
										</div>
										<div class="col-lg-5">
											<div class="mbl">SMS Route<span class="required-start">*</span></div>
											<div class="controls">
												<input type="text" name="sms_route" class="form-control" required  value="{{SMS_ROUTE}}">
											</div>
										</div>
									</div>
									<div class="row mt-2">
										<div class="col-lg-5">
											...
											<div class="controls">
												<input type="text" name="sms_api_key" class="form-control" required  value="{{SMS_API_KEY}}">
											</div>
										</div>
									</div>
