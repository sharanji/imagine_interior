				...
				<h2 class="content-header-title float-left mb-0">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item active">
							...
							?>
							<a href="{{url('manage-salesReport.html')}}" title="<?php echo $pageTitle;?>"><?php echo $pageTitle;?></a>
						</li>
					</ol>
				</h2>
			</div>
										...
										<tbody class="tb-data">
											@if ($resultData->count() > 0 )
												...
												<tr>
													...
													<td class="text-center" > <a target="_blank" title="Sales Order" href="{{url('manage-sales.html/view/'.$row->sales_id)}}"> {{$row->reference_no}} </a></td>
