                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                <div class="mbl">Department Name <span class="required-start">*</span></div>
                                <div class="controls">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <div class="mbl">Department Description</div>
                                <div class="controls">
                ...
                <form action="" method="get">
                    <div class="row">
                        <div class="col-md-3">	
                            ...
                            <span class="search-note">Note : Department Name .</p>
                        </div>	
                        <div class="col-md-3">
                            ...
                            <table class="table row-grouping dataTable" id="customers">
                                <thead class="tb-head">
                                    <tr role="row">
                                        ...
                                        <th onclick="sortTable(2)">Department Name</th>
                                        <th onclick="sortTable(3)">Department Description</th>
                                                ...
                                                <td style="width:12%;">
                                                    <div class="dropdown" style="text-align:center;">
                                                        ...
                                                        <ul class="dropdown-menu dropdown-menu-right action-links">
                                                            <li>
                                                                <a href="#" data-toggle="modal" data-target="#editModal{{$row->department_id}}" title="Edit">
                                                            ...
                                                            <li>
                                                                <?php 
                                                                    ...
                                                                    {
                                                                        ?>
                                                                        <a href="<?php echo url('manage-employeDepartments.html/status/'.$row->department_id.'/0');?>" title="Inactive"><i class="fa fa-ban"></i> Inactive</a>
                                                                        <?php 
                                                                    }
                                                                    else
                                                                    { 
                                                                        ?>
                                                                        <a href="<?php echo url('manage-employeDepartments.html/status/'.$row->department_id.'/1');?>" title="Active"><i class="fa fa-check"></i>  Active</a>
                                                                        <?php 
                                                                    } 
                                                                ?>
                                                            </li>
                                                    ...
                                                    <!-- Popup start -->
                                                    <div class="modal fade" id="editModal{{$row->department_id}}" style="z-index:99999;position:fixed;top:30px;" aria-labelledby="exampleModalLabel" tabindex="-1" role="dialog" aria-hidden="true">
                                                                ...
                                                                <form action="" method="post">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-md-6">
                                                                                <div class="form-group">
                                                                                    <div class="mbl">Department Description <span class="required-start">*</span></div>
                                                                                    <div class="controls">
                                                                                        <input type="text" class="form-control" name="department_description" value="{{$row->department_description}}" required>
                                                                                        <input type="hidden" class="form-control" name="department_id" value="{{$row->department_id}}">
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        </div>
