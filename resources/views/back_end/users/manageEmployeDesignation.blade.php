				...
				<h2 class="content-header-title float-left mb-0">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item active">
							...
							?>
							<a href="{{url('manage-employeDesignations.html')}}" title="<?php echo $pageTitle;?>"><?php echo $pageTitle;?></a>
						</li>
					</ol>
				</h2>
			</div>
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                <div class="mbl">Designation Name <span class="required-start">*</span></div>
                                <div class="controls">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <div class="mbl">Designation Description</div>
                                <div class="controls">
                                    <input type="text" name="designation_description" class="form-control" >
                                </div>
                            </div>
                        </div>
                ...
                <form action="" method="get">
                    <div class="row">
                        <div class="col-md-3">	
                            ...
                            <span class="search-note">Note : Designation Name .</p>
                        </div>	
                        <div class="col-md-3">
                            ...
                            <table class="table row-grouping dataTable" id="customers">
                                <thead class="tb-head">
                                    <tr role="row">
                                        ...
                                        <th onclick="sortTable(2)">Designation Name</th>
                                        <th onclick="sortTable(3)">Designation Description</th>
                                                ...
                                                <td style="width:12%;">
                                                    <div class="dropdown" style="text-align:center;">
                                                        ...
                                                        <ul class="dropdown-menu dropdown-menu-right action-links">
                                                            <li>
                                                                <a href="#" data-toggle="modal" data-target="#editModal{{$row->designation_id}}" title="Edit">
                                                            ...
                                                            <li>
                                                                <?php 
                                                                    ...
                                                                    {
                                                                        ?>
                                                                        <a href="<?php echo url('manage-employeDesignations.html/status/'.$row->designation_id.'/0');?>" title="Inactive"><i class="fa fa-ban"></i> Inactive</a>
                                                                        <?php 
                                                                    }
                                                                    else
                                                                    { 
                                                                        ?>
                                                                        <a href="<?php echo url('manage-employeDesignations.html/status/'.$row->designation_id.'/1');?>" title="Active"><i class="fa fa-check"></i>  Active</a>
                                                                        <?php 
                                                                    } 
                                                                ?>
                                                            </li>
                                                    ...
                                                    <!-- Popup start -->
                                                    <div class="modal fade" id="editModal{{$row->designation_id}}" style="z-index:99999;position:fixed;top:30px;" aria-labelledby="exampleModalLabel" tabindex="-1" role="dialog" aria-hidden="true">
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="col-md-6">
                                                                                <div class="form-group">
                                                                                    <div class="mbl">Designation Name <span class="required-start">*</span></div>
                                                                                    <div class="controls">
                                                                                        <input type="text" class="form-control" name="designation_name" value="{{$row->designation_name}}" required>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-md-6">
                                                                                <div class="form-group">
                                                                                    <div class="mbl">Designation Description <span class="required-start">*</span></div>
                                                                                    <div class="controls">
                                                                                        <input type="text" class="form-control" name="designation_description" value="{{$row->designation_description}}" required>
                                                                                        <input type="hidden" class="form-control" name="designation_id" value="{{$row->designation_id}}">
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        </div>
