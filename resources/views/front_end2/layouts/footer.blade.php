                     ...
                     <ul class="recent-news">
                         <li>
                             <div class="img-holder">
                                 <img src="{{asset("front_end2/images/footer/recent-news-1.jpg")}}" alt="Awesome Image">
                         ...
                         <li>
                             <div class="img-holder">
                                 <img src="{{asset("front_end2/images/footer/recent-news-2.jpg")}}" alt="Awesome Image">
                                 <div class="overlay-style-one">
                                     <div class="box">
                                         <div class="content">
                                             <a href="project-single.html"><span class="icon-next"></span></a>
                         ...
                         <li>
                             <div class="img-holder">
                                 <img src="{{asset("front_end2/images/footer/recent-news-3.jpg")}}" alt="Awesome Image">
                                 <div class="overlay-style-one">
                                     <div class="box">
                                         <div class="content">
                                             <a href="project-single.html"><span class="icon-next"></span></a>
