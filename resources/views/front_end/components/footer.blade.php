<footer class="footer" style="background-image: url('assets/images/svg-map.svg'); background-repeat: no-repeat; background-position: center;">
    <div class="container">
                ...
                <div class="col-12">
                    <div class="text-center">
                        <p class="mb-0">© <script>
                            ...
                            </script> Imagine Interiors. Design with <i class="mdi mdi-heart text-danger"></i> by <a href="https://adhiyamaan.ac.in/" target="_blank" class="text-reset">Adhiyamaan College</a>.</p>
                    </div>
                </div>
                <!--end col-->
            </div>
