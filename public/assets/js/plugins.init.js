/* Template Name: Imagine Interiors - Saas & Software Landing Page Template
   Author: Shreethemes
...
try {
    function setTheme(theme) {
        ...
        let styleHref;
        let color = "";
        if (window.theme) color = "-" + window.theme;
        switch (theme) {
            case "style-dark":
                bootstarpHref =
                    "assets/css/bootstrap-dark" + color + ".min.css";
            ...
            case "style-dark-rtl":
                bootstarpHref =
                    "assets/css/bootstrap-dark" + color + "-rtl.min.css";
        ...
        if (theme === "style-rtl" || theme === "style-dark-rtl")
